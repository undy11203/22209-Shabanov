...
void ConsoleView::PrintInfo(std::string name, std::pair<std::vector<int>, std::vector<int>> rules, std::string typeGame) {
...
void ConsoleView::PrintSuccessMessage() {
...
void ConsoleView::GetReturnCommand() {
    std::string input;
